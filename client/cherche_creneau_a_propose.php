...
<body>
    <div class="popup">
        ...
        <h3 style="text-align:center; color:red;">L'adversaire reçoit un message afin de valider ou non votre demande</h3>
                        ...
                        while ($current_date <= $end_date) {
                            ...
                            foreach ($creneaux_possibles as $creneau) {
                                ...
                                if ($creneau_occupe) {
                                    ...
                                    $jour = $current_date->format('Y-m-d'); // ou 'd/m/Y' pour affichage
                                    $heure = $creneau;
                                    ...
                                    $url = "proposer_un_creneau.php?jour=$jour&heure=$heure&partie=$partie_a_replacer&equipe_id=$equipe_id&equipe_demande=$team_id";

                                    echo "<a href=\"$url\" onclick=\"return confirm('Êtes-vous sûr de vouloir prendre ce créneau ?');\">";
