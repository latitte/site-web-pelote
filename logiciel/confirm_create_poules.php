...
<head>
    ...
    <title>Création Poules Auto</title>
...
<body>
    <div class="container">
        ...
        <button id="createPoolsButton">Créer les poules</button>
        <iframe id="resultsIframe" src="resultats_poules.html"></iframe>
    ...
    setInterval(function() {
        ...
        xhr.open('HEAD', 'resultats_poules.html', true);
    ...
    document.getElementById('createPoolsButton').addEventListener('click', function() {
        if (confirm('Êtes-vous sûr de vouloir créer les poules ?')) {
            showLoader(); // Afficher le loader avant l'appel AJAX

            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'create_poules_auto.php', true);
