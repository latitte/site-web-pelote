...
$team1_id = isset($_GET['team1']) ? $_GET['team1'] : null;
$team2_id = isset($_GET['team2']) ? $_GET['team2'] : null;
...
<div class="form-group">
    ...
    <div style="display: flex; gap: 10px; flex-direction: column;">
        ...
        <input type="text"
            id="partie"
            name="partie"
            value="<?php echo htmlspecialchars($partie ?? '', ENT_QUOTES, 'UTF-8'); ?>"
            required readonly
            style="flex: 1;">
    ...
    <div id="resultats-creneaux"
        style="margin-top: 15px; font-size: 16px; color: #333;">
    </div>
</div>
    ...
    <a href="../partie_non_placee.php" class="btn-back">Retour</a>
</div>
