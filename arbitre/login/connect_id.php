...
$password_correct = $parametres['pass_arbitre'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($pass == $password_correct ) {
        ...
        header("Location: ./create_fingerprint.php"); // Redirection vers une page sécurisée après connexion
        exit();
    } else {
...
<body>
    <div class="popup">
        ...
        <h3>Votre empreinte n'a pas pu être reconnue</h3>
        <?php if ($error): ?>
            <div class="error"><?php echo $error; ?></div>
        <?php endif; ?>
        <form method="POST" action="">
            <!-- <div class="input-group">
                <label for="identifiant">Nom Prenom</label>
